  ...
  return (
    <div className="container">
      <Switch>
        ...
        ></Route>
        <Route
          path="/users/:id/blogs/new"
          component={withAuth(BlogForm)}
        ></Route>
        <Route
          path="/users/:id/blogs/:blog_id"
          render={(props) => {
            if (
              currentUser.isAuthenticated &&
              Number(props.match.params.id) === currentUser.user.id
            ) {
      ...
      {isSignin && (
        <MessageInfo
          messageText={successfulMessage + 'signed in'}
          isGreen={true}
          postMessage={() => {
            setIsSignin(false);
          }}
      ...
      {isSignup && (
        <MessageInfo
          messageText={successfulMessage + 'signed up'}
          isGreen={true}
          postMessage={() => {
            setIsSignup(false);
          }}
...
export default withRouter(
  connect(mapStateToPorps, { authUser, removeError })(Main)
);
